        ...
        <form class="col s12">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input placeholder="Placeholder" id="nombre_entrenador" type="text" class="validate">
            ...
            <a class="waves-effect waves-light btn" id="btnGuardar">Guardar</a>
